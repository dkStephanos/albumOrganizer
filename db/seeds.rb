...
magicalMysteryTour.songs.create(name: "Strawberry Fields Forever", length: 245, genre_id: rock.id)
...
rubberSoul.songs.create(name: "Michelle", length: 160, genre_id: rock.id)
