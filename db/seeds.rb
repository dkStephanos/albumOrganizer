...
magicalMysteryTour.songs.create(name: "I Am the Walrus", length: 275, is_favorite: true, genre_id: rock.id)
magicalMysteryTour.songs.create(name: "Hello, Goodbye", length: 204, genre_id: rock.id)
magicalMysteryTour.songs.create(name: "Strawberry Fields Forever", length: 245, is_favorite: true, genre_id: rock.id)
...
rubberSoul.songs.create(name: "Norwegian Wood (This Bird Has Flown)", length: 121, is_favorite: true, genre_id: rock.id)
...
rubberSoul.songs.create(name: "Michelle", length: 160, is_favorite: true, genre_id: rock.id)
